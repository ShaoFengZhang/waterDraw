/**
 * Created by yanglinkai on 18/07/2018.
 */
function r(n, r) {
...
function f(n, t) {
  ...
  for (f = 0; f < n.length; f += 16) i = l, a = v, h = d, g = C, v = c(v = c(v = c(v = c(v = u(v = u(v = u(v = u(v = o(v = o(v = o(v = o(v = e(v = e(v = e(v = e(v, d = e(d, C = e(C, l = e(l, v, d, C, n[f], 7, -680876936), v, d, n[f + 1], 12, -389564586), l, v, n[f + 2], 17, 606105819), C, l, n[f + 3], 22, -1044525330), d = e(d, C = e(C, l = e(l, v, d, C, n[f + 4], 7, -176418897), v, d, n[f + 5], 12, 1200080426), l, v, n[f + 6], 17, -1473231341), C, l, n[f + 7], 22, -45705983), d = e(d, C = e(C, l = e(l, v, d, C, n[f + 8], 7, 1770035416), v, d, n[f + 9], 12, -1958414417), l, v, n[f + 10], 17, -42063), C, l, n[f + 11], 22, -1990404162), d = e(d, C = e(C, l = e(l, v, d, C, n[f + 12], 7, 1804603682), v, d, n[f + 13], 12, -40341101), l, v, n[f + 14], 17, -1502002290), C, l, n[f + 15], 22, 1236535329), d = o(d, C = o(C, l = o(l, v, d, C, n[f + 1], 5, -165796510), v, d, n[f + 6], 9, -1069501632), l, v, n[f + 11], 14, 643717713), C, l, n[f], 20, -373897302), d = o(d, C = o(C, l = o(l, v, d, C, n[f + 5], 5, -701558691), v, d, n[f + 10], 9, 38016083), l, v, n[f + 15], 14, -660478335), C, l, n[f + 4], 20, -405537848), d = o(d, C = o(C, l = o(l, v, d, C, n[f + 9], 5, 568446438), v, d, n[f + 14], 9, -1019803690), l, v, n[f + 3], 14, -187363961), C, l, n[f + 8], 20, 1163531501), d = o(d, C = o(C, l = o(l, v, d, C, n[f + 13], 5, -1444681467), v, d, n[f + 2], 9, -51403784), l, v, n[f + 7], 14, 1735328473), C, l, n[f + 12], 20, -1926607734), d = u(d, C = u(C, l = u(l, v, d, C, n[f + 5], 4, -378558), v, d, n[f + 8], 11, -2022574463), l, v, n[f + 11], 16, 1839030562), C, l, n[f + 14], 23, -35309556), d = u(d, C = u(C, l = u(l, v, d, C, n[f + 1], 4, -1530992060), v, d, n[f + 4], 11, 1272893353), l, v, n[f + 7], 16, -155497632), C, l, n[f + 10], 23, -1094730640), d = u(d, C = u(C, l = u(l, v, d, C, n[f + 13], 4, 681279174), v, d, n[f], 11, -358537222), l, v, n[f + 3], 16, -722521979), C, l, n[f + 6], 23, 76029189), d = u(d, C = u(C, l = u(l, v, d, C, n[f + 9], 4, -640364487), v, d, n[f + 12], 11, -421815835), l, v, n[f + 15], 16, 530742520), C, l, n[f + 2], 23, -995338651), d = c(d, C = c(C, l = c(l, v, d, C, n[f], 6, -198630844), v, d, n[f + 7], 10, 1126891415), l, v, n[f + 14], 15, -1416354905), C, l, n[f + 5], 21, -57434055), d = c(d, C = c(C, l = c(l, v, d, C, n[f + 12], 6, 1700485571), v, d, n[f + 3], 10, -1894986606), l, v, n[f + 10], 15, -1051523), C, l, n[f + 1], 21, -2054922799), d = c(d, C = c(C, l = c(l, v, d, C, n[f + 8], 6, 1873313359), v, d, n[f + 15], 10, -30611744), l, v, n[f + 6], 15, -1560198380), C, l, n[f + 13], 21, 1309151649), d = c(d, C = c(C, l = c(l, v, d, C, n[f + 4], 6, -145523070), v, d, n[f + 11], 10, -1120210379), l, v, n[f + 2], 15, 718787259), C, l, n[f + 9], 21, -343485551),
